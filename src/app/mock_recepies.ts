...
export const RECIPES: Recipe[] = [
  {
    ...
    videos: ['RXxjATn39i0', '-gF8d-fitkU', 'jyayNr65OHc']
  ...
  },
  {
    ...
    steps:
      ...
      'Add the onion, celery and carrot, and cook over a medium heat for 5 mins, stirring occasionally, until softened.',
      'Add the garlic and cook for 1 min, then tip in the mince and cook, stirring and breaking it up with a wooden spoon, for about 6 mins until browned all over.',
      'Stir in the tomato purée and cook for 1 min, mixing in well with the beef and vegetables. Tip in the chopped tomatoes.',
      'Fill each can half full with water to rinse out any tomatoes left in the can, and add to the pan.',
      'Add the honey and season to taste.',
      'Simmer for 20 mins.',
      'Heat oven to 200C/180C fan/gas 6.',
  ...
  },
  {
    ...
    steps:
      ...
      'Using your fingers, mix together until the mixture resembles breadcrumbs.',
      'Add about 3 tbsp cold water – 1 tbsp at a time – to bind the mixture into a ball.',
      'Then wrap it in cling film and leave to chill in the fridge while you prepare the apples, or for 30 mins if you have time.',
      'While the pastry is chilling, core the apples, then cut into even-sized chunks so they all cook in the same amount of time.',
      'Put the apples into the pie dish, drizzle over the honey and add the cinnamon, mixed spice and about 2 tbsp water.',
      'Roll out the pastry on a floured work surface until it is large enough to cover the pie dish.',
      'Using the rolling pin, carefully lift the pastry and lay it over the top of the apple mixture.',
      'Carefully trim off the excess pastry (this can be rerolled and cut into shapes to decorate the pie crust if you like) and press the pastry edges onto the dish to create a seal.',
      'Make a small cut in the pastry so that the air can escape during cooking, then brush with beaten egg to glaze.',
      'Bake the pie in the oven for 20-30 mins until the pastry is golden and sandy in appearance and the apple filling is bubbling and hot.',
  ...
  },
  {
    ...
    ingredients: [
      ...
      'corn'],
    steps:
      ['Heat the oil in a large, deep frying pan or saute pan.',
      'Season the chicken and fry over a medium-high heat for 2-3 mins each side or until golden.',
      'Transfer to a plate.',
      'Add the onion and pepper to the pan and cook for 3 mins, stirring, until softened and lightly browned.',
      'Tip in the garlic and beans, and stir-fry for 2 mins.',
      'Add the chilli and spices, then stir in the quinoa and sweetcorn.',
      'Pour in 700ml just-boiled water with 1/2 tsp flaked sea salt and bring to the boil.',
      'Return the chicken to the pan, reduce the heat to a simmer and cook for 12 mins, stirring regularly and turning the chicken occasionally.',
      'Add the kale and cook for a further 3 mins or until the quinoa and chicken are cooked through.'],
  ...
  },
  {
    ...
    steps:
      ...
      'Add the lemon and tomatoes, and roast for 10 mins, then top with the fish fillets and cook for 10 mins more.',
  ...
  },
  {
    ...
    steps:
      ...
      'Put each piece of toast on a small plate, then halve burratas and gently spread over the toast.',
  ...
  },
  {
    ...
    ingredients: [
      ...
      'garlic'],
    steps:
      ['De-stone and quarter the peaches.',
      'Put in a roasting tin with the seeds, chunks of feta and drizzle over 3 tbsp olive oil.',
      'Bake for 12-15 mins at 200C/180C fan/gas 6.',
      'Cook the couscous following pack instructions.',
      'Toss the couscous with the roasted peach mixture and season to taste before serving.'],
  ...
  },
  {
    ...
    steps:
      ...
      'Add the onions with a pinch of salt, and cook until translucent, around 3-4 mins.',
      'Add the garlic and cook for a minute more.',
      'Stir in the beans, cumin, chilli powder, oregano, some seasoning and 100ml water.',
      'Cook for 5-7 mins, stirring occasionally, or until the beans have softened, then remove from the heat, mash and set aside.',
      'Heat the remaining oil in a large frying pan over a medium-high heat.',
      'Crack in the eggs, then reduce the heat to low and cook slowly until the whites are completely firm.',
      'To assemble, spread the beans onto the tortillas, add the tomatoes and jalapeños and sprinkle with cheese.',
      'Top with some avocado, a squeeze of lime juice and a fried egg, then scatter with coriander.',
  ...
  },
  {
    ...
    ingredients: [
      ...
      'lime'],
    steps:
      ['Very simply, you just mix the cabbage, carrots, ginger, chilli, lime zest and juice, the sesame seeds and oils with salt.',
      'Then add a little sugar to taste.',
      'It will keep in the fridge for up to a couple of days.'],
  ...
  },
  {
    ...
    steps:
      ...
      'Cut the chicken wings into winglets by slicing through each of the joints.',
      'Keep the two meaty pieces and discard the wing tips, or freeze for stock.',
      'Put the winglets on a large baking sheet, drizzle with the olive oil, then season.',
      'Roast in the oven for 20 mins, then reduce the temperature to 180C/160C fan/ gas 4 and cook for a further 25 mins.',
      'Meanwhile, make the barbecue sauce.',
      'Put all the ingredients, except the butter, in a pan and mix together with plenty of black pepper.',
      'Let it bubble away for 3-5 mins to thicken up a little, then add the butter and stir until it has melted and made the sauce nice and shiny.',
      'Season to taste.',
      'Half an hour before the chicken wings are ready, take them out of the oven and brush over three-quarters of the barbecue sauce.',
      'When they’re fully cooked, toss them in the rest of the sauce so that they become sticky.',
      'In a small bowl, mash the blue cheese dressing ingredients together with some seasoning, until combined.',
      'The barbecue sauce and dip can be made a day ahead, covered and chilled.',
      'Serve alongside the wings with the celery sticks and radishes for dipping.'],
  ...
  },
  {
    ...
    steps:
      ['Put 9 eggs into a large saucepan.',
      'Cover with cold water and bring to the boil.',
      'Once boiling, set the timer for 5 mins.',
      'When 5 mins is up, quickly lift the eggs out with a slotted spoon and plunge into a big bowl of cold water.',
      'Put the sausagemeat, parsley, Worcestershire sauce, mustard powder and mace into a bowl with plenty of seasoning.',
      'Break in 1 of the remaining eggs and mix everything together.',
      'Crack remaining 2 eggs into a bowl, beat with a fork, then sieve onto a plate.',
      'Tip the flour onto another plate and season well.',
      'Finally, tip the breadcrumbs onto a third plate.',
      'Bring a large saucepan of water to the boil.',
      'Drop in the bacon rashers, turn off the pan and fish out the bacon with a pair of tongs – it should be just cooked.',
      'When the eggs are cool, tap lightly on a hard surface to crack the shell, then peel.',
      'If you hold the eggs over the bowl of water as you peel, all the shell bits will collect in there and you can dip in the egg to wash off any fragments.',
      'Wrap a slice of bacon around the middle of each egg, overlapping, like a belt.',
      'Now finish coating the eggs.',
      'I set up the ingredients along my bench like a conveyer belt: eggs, then flour, mince, beaten egg and finally breadcrumbs, plus a baking parchment-lined tray at the end to put the finished scotch eggs on.',
      ...
      'Sit the egg on the meat, then mould over the mince to cover, squeezing and patting so it is an even thickness.',
      'You’ll probably have a gap (depending on how big your hands are – just patch and pat with a bit more mince).',
      ...
      'To cook, pour the oil in a large, deep saucepan to about 4cm deep.',
      'Heat until a small chunk of bread browns in about 1 min.',
      'Carefully lower in a scotch egg and fry for about 5 mins, turning gently, until evenly browned.',
      'Depending on your pan, you can probably do 2-3 at a time, but don’t overcrowd.',
      'Lift out onto a kitchen paper-lined tray. (If you like your scotch eggs warm, pop them into a low oven while you fry the rest) keep an eye on the oil – if the scotch eggs start browning too quickly, the oil might be too hot and you risk the pork not being cooked before the scotch egg is browned.',
      'If the oil gets too cool, the scotch egg may overcook before it is browned.',
      'enjoy warm or cold; best eaten within 24 hrs of frying.',
      'Watch our scotch egg video for an easy to follow tutorial.'],
  ...
  },
  {
    ...
    steps:
      ['Heat the oil in a large lidded pan, stir in the onions and cook for 8 mins until soft.',
      'Tip in the mustard seeds and cook for 1 min until toasted.',
      'Stir through the curry paste and sizzle for 3 mins.',
      'Mix the beetroot through the spicy onions, then add the chilli, tomatoes and 2 cans of water.',
      'Cover and simmer for 30 mins, stirring occasionally, until the beetroot is tender.',
      'Remove the lid, turn up the heat and cook until the sauce is thick.',
      'Take off the heat, then stir through the almonds, yogurt and some seasoning.',
  ...
  },
  {
    ...
    ingredients: [
      ...
      'oyster sauce'],
    steps:
      ['Heat the oil in a large wok or frying pan, then tip in the garlic and cook for a few secs.',
  ...
  },
  {
    ...
    steps:
      ...
      'Drain and keep warm.',
      'Return stock to the boil.',
      'Add the fish sauce, chillies and garlic, reduce the heat and simmer for 2 mins.',
      ...
      'Divide the noodles between soup bowls.',
  ...
  },
  {
    ...
    ingredients: [
      ...
      'lime'],
    steps:
      ['Put the chicken breast between 2 pieces of cling film and bash with a rolling pin to about 1cm thick.',
      'Heat a griddle pan until hot.',
      'Rub the chicken with the oil, cook for 2-3 mins per side, or until cooked through.',
      'Set aside to cool.',
      'Mix together the rice vinegar, sugar and lime juice, stirring until the sugar is dissolved.',
      'Add the carrot, spring onions, cucumber and chilli.',
      'Split a sandwich baguette along the top.',
      'Stuff with the Little Gem leaves and shred the chicken on top.',
      'Pile on the carrot mixture and wrap or place in a plastic box.',
      'Put the sweet chilli sauce in a small portable pot and when it’s time for lunch, pour over the sauce just before tucking in.'],
  ...
  },
  {
    ...
    videos: ['RwDCPU7jveM','k163JrPk-Qs','tpabh0IgEz4']
  },
];
